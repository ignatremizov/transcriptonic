...
copy_common() {
  ...
  local files=(background.js content-google-meet.js content-teams.js content-zoom.js meetings.html meetings.js popup.html popup.js icon.png rules.json)
  for f in "${files[@]}"; do
...
strip_ts_refs "$CHROME_OUT/content-google-meet.js"; strip_ts_refs "$CHROME_OUT/content-teams.js"; strip_ts_refs "$CHROME_OUT/content-zoom.js"; strip_ts_refs "$CHROME_OUT/background.js"
...
strip_ts_refs "$FIREFOX_OUT/content-google-meet.js"; strip_ts_refs "$FIREFOX_OUT/content-teams.js"; strip_ts_refs "$FIREFOX_OUT/content-zoom.js"; strip_ts_refs "$FIREFOX_OUT/background.js"
